...
# Aliases
if [ -f $HOME/.config/fish/bindings.fish ]
...
set -U fish_user_paths $HOME/.bin $HOME/.local/bin $HOME/Applications $fish_user_paths $HOME/.cargo/env
...
export PATH="/home/viktorhg/.scripts:$PATH"
export PATH="/home/viktorhg/.local/share/gem/ruby/3.0.0/bin:$PATH"
